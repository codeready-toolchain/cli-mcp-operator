...
- **Pro:** Standing up an instance is CR + investigation Secret (and TLS off OpenShift). Client grant is instance-scoped. Operator ClusterRole is `bind` + one named CRB, not unbound CRB verbs.
