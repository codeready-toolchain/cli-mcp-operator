...
// Phase 4 (SANDBOX-1983): namespaced child verbs (pods, secrets) must be a Role in the
// OperatorGroup target namespace, not extra rules on this ClusterRole.
...
// the CliMcpInstance object against the actual cluster state, and then
// perform operations to make the cluster state reflect the state specified by
// the user.
//
// For more details, check Reconcile and its Result here:
// - https://pkg.go.dev/sigs.k8s.io/controller-runtime@v0.21.0/pkg/reconcile
func (r *CliMcpInstanceReconciler) Reconcile(ctx context.Context, _ ctrl.Request) (ctrl.Result, error) {
